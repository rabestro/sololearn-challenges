...
As an answer to the #OneLiners challenge from SoloLearn I also created [One-Line solutions in Ruby](ONE_LINERS_RUBY.md) and [One-Statement](one-statement) solutions in Java language for about 60% problems.
